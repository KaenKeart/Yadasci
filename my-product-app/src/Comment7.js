...
export default function Comment7() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/7");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/7", {
      method: "POST",
      headers: {
