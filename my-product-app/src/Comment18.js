...
export default function Comment18() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/18");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/18", {
      method: "POST",
      headers: {
