...
export default function Comment24() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/24");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/24", {
      method: "POST",
      headers: {
