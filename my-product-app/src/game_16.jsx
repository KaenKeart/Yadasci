...
function Game16() {
  return (
    <div>
      ...
      <h3 id="DetailGame">
        รายละเอียด ผู้ชายวัยรุ่นส่วนใหญ่ต่างหมายครอบครองเจ้าหญิงอันสิริงดงาม
        แต่เธอกลับขังตัวอยู่ในปราสาท
        เราจึงต้องพยายามให้คนอื่นๆในวังช่วยส่งจดหมายรักของเราไปถึงมือเธอให้จงได้
