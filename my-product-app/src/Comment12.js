...
export default function Comment12() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/12");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/12", {
      method: "POST",
      headers: {
