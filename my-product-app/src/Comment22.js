...
export default function Comment22() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/22");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/22", {
      method: "POST",
      headers: {
