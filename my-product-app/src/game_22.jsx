...
<div>
    ...
    <section id="basket">
      ...
      <h3 id="DetailGame">รายละเอียด ณ นครนิวยอร์คในช่วงยุค 60 เป็นช่วงทีช่าวจีนต่างหลั่งไหลอพยพเข้าไปตั้ง รกรากในบริเวณไชน่าทาวน์กันอย่างอุ่นหนาฝาคั่ง อันเป็นผลพวงมาจากกฎหมาย ด้านการอพยพฉบับใหม่ ไชน่าทาวน์จึงขยายอาณาเขตไปทางเหนือจนถึงฝั่งถนน แคนัลสตรีท จรดถนนโบเวอรี่สตรีททางตะวันออก โดยเหล่าผู้อพยพจากแดนมังกรทั้งชายและหญิงหลายพันคนที่เข้ามาแสวงโชคใน เมืองศิวิไลซ์แห่งนี้ล้วนขยันขันแข็ง ลงทุนกว้านซื้ออาคารพาณิชย์เพื่อประกอบธุรกิจต่าง ๆ เพื่อสร้างฐานะให้มั่งคั่งตาม อุดมคติของ “ความฝันอเมริกันชน”! ในเกม “ไชน่าทาวน์” นี้ ผู้เล่นจะได้สวมบทบาทเป็นพ่อค้าแม่ค้าชาวจีนโพ้นทะเลที่หอบเอาทรัพย์สินและความฝัน ทั้งหมดมาทุ่มเพื่อสร้างฐานะในเมือง “บิ๊กแอปเปิล” แห่งนี้! ด้วยหัวการค้าที่คุณมี… คุณมัน่ใจแค่ไหนว่าจะขยับ ขยายกิจการได้จนมั่งคั่งมากกว่าใคร ๆ</h3>
      <Link to={`http://localhost:3000/comment/add/22`}>Comment</Link>
    <Footer/>
</div>      
