...
export default function Comment15() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/15");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/15", {
      method: "POST",
      headers: {
