...
export default function Comment21() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/21");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/21", {
      method: "POST",
      headers: {
