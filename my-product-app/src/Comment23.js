...
export default function Comment23() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/23");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/23", {
      method: "POST",
      headers: {
