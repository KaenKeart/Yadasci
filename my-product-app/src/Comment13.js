...
export default function Comment13() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/13");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/13", {
      method: "POST",
      headers: {
