...
export default function Comment10() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/10");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/10", {
      method: "POST",
      headers: {
