...
export default function Comment20() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/20");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/20", {
      method: "POST",
      headers: {
