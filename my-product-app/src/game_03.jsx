    ...
    <section id="basket">
        ...
        <ul className="elementor-icon-list-items">
          <li className="elementor-icon-list-item">
            ...
            <span className="elementor-icon-list-text">ประเภทบอร์ดเกม: ครอบครัว,กลยุทธ์</span>
          </li>
          <li className="elementor-icon-list-item">
            <span className="elementor-icon-list-icon">
				</span>
          ...
          <li className="elementor-icon-list-item">
            ...
            <span className="elementor-icon-list-text">จำนวนผู้เล่น: 2-7 คน</span>
          </li>
        </ul>
      ...
      <h3 id="DetailGame">สวมบทบาทผู้ปกครองอารยธรรมมหาอํานาจทั้งเจ็ดในประวัติศาสตร์โลก ใช้ทรัพยากรที่มีอย่างชาญฉลาด เพื่อพัฒนาอารยธรรมให้เจริญรุ่งเรือง สานสัมพันธไมตรีด้านการค้าพร้อมทั้งตระเตรียมไพร่พละกําลังทหารเพื่อคานอํานาจกับอารยธรรมอื่น ๆ ทิ้งร่องรอยของอารยธรรมไว้ให้
หลงเหลืออยู่ในประวัติศาสตร์ โดยการสร้างสิ่งปลูกสร้างขนาดมหึมาที่จะยังคงตั้งตระหง่านอยู่คู่กาลเวลา</h3>
    <Footer/>
</div>      
