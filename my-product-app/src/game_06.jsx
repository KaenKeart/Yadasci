    ...
    <section id="basket">
        ...
        <ul className="elementor-icon-list-items">
          ...
          <li className="elementor-icon-list-item">
            ...
            <span className="elementor-icon-list-text">จำนวนผู้เล่น: 2 คน</span>
          </li>
        </ul>
      ...
      <h3 id="DetailGame">วิธีการเล่น เตรียมบอร์ดเกม
...
วิธีจบ
เมื่อฝ่ายใด ฝ่ายนึง “รุกจน” (checkmate) คิงฝ่ายตรงข้ามได้ จะชนะ</h3>
    <Footer/>
</div>      
