...
export default function Comment6() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/6");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/6", {
      method: "POST",
      headers: {
