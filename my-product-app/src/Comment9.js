...
export default function Comment9() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/9");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/9", {
      method: "POST",
      headers: {
