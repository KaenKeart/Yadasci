...
function Game23() {
  return (
    <div>
      ...
      <h3 id="DetailGame">
        รายละเอียด ในเกมหนึ่งคืนปริศนาเกมล่ามนุษย์หมาป่า
        เป็นเกมที่สามารถเล่นได้รวดเร็ว สำหรับผู้เล่น 3-10 คน
        โดยแต่ละคนจะได้รับบทบาทเป็นคนในหมู่บ้าน ที่จะมีมนุษย์หมาป่าแฝงตัวเข้ามา
        คนอื่นๆต้องพยายามหามนุษย์หมาป่า เพื่อที่จะกำจัดออกจากหมู่บ้านไป
