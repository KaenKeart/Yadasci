...
export default function Comment8() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/8");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/8", {
      method: "POST",
      headers: {
