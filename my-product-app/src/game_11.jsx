...
<div>
    ...
    <section id="basket">
      ...
      <h3 id="DetailGame">ภาคเสริม ถนนลี้ลับแห่งอาร์คัม มาพร้อมกับสถานที่อันโด่งดังของเมืองอาร์คัมและความลับอันชั่วร้ายที่ปิดซ่อนอยู่ภายในนั้น เนื้อเรื่องตอนใหม่ 3 ตอนที่เพิ่มเข้ามาจะท้าทายความสามารถของนักสืบ เมื่อต้องเผชิญหน้ากับผู้รุกรานจากโพ้นดารา พลังอำนาจอันเกินจินตนาการ และเหล่าอาชญากรร้ายแสนป่าเถื่อน เพื่อที่จะต่อกรกับทั้งอสูรร้ายจากบรรพกาลและเหล่าคนชั่วช้าในโลกปัจจุบัน นักสืบจำเป็นต้องปลุกพลังที่แท้จริงในตัวให้ตื่นขึ้นด้วยเวทมนตร์เหนือธรรมชาติ วัตถุลี้ลับอันทรงพลังและน้ำยาสีอำพันพิศวง ไม่ว่าจะต้องจ่ายราคาด้วยอะไร คุณก็จำเป็นต้องปกป้องเมืองอาร์คัมแห่งนี้ไว้ให้จงได้</h3>
      <Link to={`http://localhost:3000/comment/add/11`}>Comment</Link>
    <Footer/>
</div>      
