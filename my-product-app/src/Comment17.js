...
export default function Comment17() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/17");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/17", {
      method: "POST",
      headers: {
