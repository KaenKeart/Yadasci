...
function Game17() {
  return (
    <div>
      ...
      <h3 id="DetailGame">
        รายละเอียด “เกมนี้ก็คล้ายๆ UNO (อูโน่) เพียงแต่มีแพะ มีขนมโตเกียววิเศษ
        แล้วก็มีแมวเหมียวที่ฆ่าคุณได้” – CNN สร้างสรรค์โดย Elan Lee (XBOX,
        ARGs), Matthew Inman (The Oatmeal), และ Shane Small (XBOX, Marvel)
        เกมแมวระเบิดเป็นเกมที่สร้างปรากฎการณ์ใน Kickstarter เมื่อปี 2015
        โดยมีผู้ร่วมระดมทุนกว่า 219,000 คน รูปแบบการเล่น
        เหมือนการเดิมพันรัสเชียนรูเล็ตต์ที่ต้องอาศัยกลยุทธ์และพลังแมวเหมียว
        ผู้เล่นจะผลัดกันจั่วการ์ดจนกว่าจะมีคนจั่วเจอแมวระเบิด
        และระเบิดตัวตายออกจากเกม
        นอกจากว่าจะมีการ์ดปลดระเบิดที่ช่วยให้รอดตายจากแมวด้วยการใช้ปากกาเลเซอร์ล่อแมว
        เกาพุง หรือแซนวิชกัญชาแมว ส่วนการ์ดอื่นๆ
