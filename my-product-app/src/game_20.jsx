...
import game_20_2 from '../src/img/game_20-2.jpg'
import './game.css';
...
<div>
    ...
    <img src={game_20_2} className="img_responsive" alt="..."/>
      </Carousel.Item>
    </Carousel> 
     </div>
    <section id="basket">
      ...
      <h3 id="DetailGame">รายละเอียด เกมค้าเพชรเป็นเกมที่เราจะต้องสะสมเพชรในการซื้อการ์ดต่างๆ การ์ดแต่ละใบจะเหมือนเรากำลังเพิ่มการขับเคลื่อนอุตสาหกรรมอัญมณีของเราให้เติบโตขึ้น การ์ดจะมีตั้งแต่ แหล่งหาเพชร การขนส่ง คนเจียรไน ไปถึงการเปิดหน้าร้าน เพื่อจะให้ได้แต้มเกียรติยศเยอะที่สุดในตอนจบเกม และในบางครั้งถ้าเราจัดการธุรกิจของเราได้ดีพอเหล่าขุนนางก็จะแวะเวียนมาชื่นชมด้วย ก็จะยิ่งเป็นเกียรติให้กับร้านค้าของเราเป็นอย่างมาก</h3>
    <Footer/>
</div>      
