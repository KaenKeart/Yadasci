...
function Game18() {
  return (
    <div>
      ...
      <h3 id="DetailGame">
        รายละเอียด
        เกมเจรจาต่อรองที่มาในรูปแบบของการนำสินค้าเข้าเมืองที่เต็มไปด้วยการชิงเหลียมเพื่อชัยชนะ
        เกมนี้ผู้เล่นจะสวมบทบาทพ่อค้าแม่ค้า
        และจะต้องทำทุกวิถีทางเพื่อทำกำไรให้ได้มากที่สุดจากสินค้าที่มี
        ทั้งจากสินค้าที่ได้รับอนุญาต หรือลักลอบขนของเถี่อนราคาแพงเข้ามาขาย
