    ...
    <section id="basket">
        ...
        <ul className="elementor-icon-list-items">
          ...
          <li className="elementor-icon-list-item">
            ...
            <span className="elementor-icon-list-text">จำนวนผู้เล่น: 5-75 คน</span>
          </li>
        </ul>
      ...
      <h3 id="DetailGame">เกมล่าปริศนามนุษย์หมาป่า เป็นเกมแนวตัดตัวเลือกระหว่างผู้เล่น 2 ทีม คือทีมชาวบ้าน และมนุษย์หมาป่า ฝ่ายชาวบ้านจะไม่รู้ว่าใครเป็นมนุษย์หมาป่า และฝั่งหมาป่าต้องพยายามแฝงตัวค่อย ๆ กำจัดฝ่ายชาวบ้านไปทีละคน เพื่อชัยชนะ โดยตัวเกมจะมี ผู้ดำเนินเกม (ที่ไม่อยู่ฝ่ายใด) เป็นคนทำหน้าที่ดำเนินเกม</h3>
    <Footer/>
</div>      
