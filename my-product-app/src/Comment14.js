...
export default function Comment14() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/14");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/14", {
      method: "POST",
      headers: {
