...
export default function Comment16() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/16");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/16", {
      method: "POST",
      headers: {
