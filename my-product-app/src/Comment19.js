...
export default function Comment19() {
  ...
  useEffect(() => {
    async function fetchData() {
      let json = await API_GET("comment/add/19");
  ...
  const onSave = async (event) => {
    ...
    const response = await fetch("http://localhost:8000/comment/add/19", {
      method: "POST",
      headers: {
