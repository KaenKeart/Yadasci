...
<div>
    ...
    <section id="basket">
      ...
      <h3 id="DetailGame">วิธีการเล่น

ผู้เล่นเลือกแม่เหล็กไปคนละ 1 ชิ้น ผู้เล่นที่อายุน้อยที่สุดเริ่มเล่นเป็นคนแรก เมื่อถึงตาเล่นให้ผู้เล่นทอยเต๋า จากนั้นเดินชิ้นส่วนแม่เหล็กของตัวเองไปตามช่องเท่ากับจำนวนหน้าเต๋าที่ทอยได้ หากตกที่ช่องว่าง ให้ทำแอคชั่นที่กำหนดไว้ในช่องนั้น หากตกช่องบันไดให้ขึ้นไปสุดบันได หากตกช่องที่มีงูให้เดินลงข้างล่างจนสุดตัวงู หากตกช่องตัวเลข ให้ย้ายไปช่องที่มีเลขกำกับไว้ทันที

วิธีจบ

เป็นคนแรกที่ไปถึงช่องสุดท้ายที่อยู่ด้านบนของกระดาน</h3>
    <Footer/>
</div>      
